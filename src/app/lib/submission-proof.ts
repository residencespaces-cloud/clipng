...
export function createVerificationCode(campaignId: number) {
  return `#CNG-${String(campaignId).padStart(2, "0")}-A7K2`;
}

export function validatePublicPostUrl(value: string, platform: string) {
