...
export function HowItWorks() {
  return (
    <section id="how" className="py-16 sm:py-24 px-4 sm:px-6 border-t border-border">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          {[
            ...
            <div key={s.num} className="relative bg-card border border-border rounded-xl p-5 sm:p-6 hover:border-primary/30 transition-colors group">
              <div
                className="absolute top-4 right-4 text-3xl sm:text-4xl font-black text-border"
              ...
              <h3 className="font-bold mb-2 capitalize pr-10">{s.title}</h3>
