  ...
  const launchCampaign = async () => {
    ...
    try {
      await api.campaigns.create({
        ...
        requiredCaption: form.requiredCaption || undefined,
        minClipSeconds: form.minClipSeconds || undefined,
        maxClipSeconds: form.maxClipSeconds || undefined,
        maxClipsPerClipper: form.maxClipsPerClipper || undefined,
        rulesDo: form.rulesDo || undefined,
        rulesDont: form.rulesDont || undefined,
