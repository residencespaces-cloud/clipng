...
let JobsService = class JobsService {
    ...
    async expireCampaigns() {
        ...
        await this.prisma.campaign.updateMany({
            ...
            data: { status: client_1.CampaignStatus.ended },
        });
    }
...
], JobsService.prototype, "expireCampaigns", null);
__decorate([
    (0, schedule_1.Cron)(schedule_1.CronExpression.EVERY_5_MINUTES),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], JobsService.prototype, "processNotifications", null);
__decorate([
    (0, schedule_1.Cron)(schedule_1.CronExpression.EVERY_DAY_AT_1AM),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], JobsService.prototype, "reconcileWebhooks", null);
